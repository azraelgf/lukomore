(() => {
    ...
    function initSliders() {
        if (document.querySelector(".why__body")) new swiper_core_Swiper(".why__body", {
            ...
            navigation: {
                prevEl: ".why-btn.swiper-button-prev",
                nextEl: ".why-btn.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".dop-classes__body")) new swiper_core_Swiper(".dop-classes__body", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".dop-classes-btn.swiper-button-prev",
                nextEl: ".dop-classes-btn.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector("._main.tariffs__body")) new swiper_core_Swiper("._main.tariffs__body", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".tariffs-btn.swiper-button-prev",
                nextEl: ".tariffs-btn.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".team__body")) {
            ...
            resizableSwiper("(max-width: 479.98px)", ".team__body", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".reviews__body")) new swiper_core_Swiper(".reviews__body", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".page_price .tariffs__body")) {
            const resizableSwiper = (breakpoint, swiperClass, swiperSettings, callback) => {
                let swiper;
                breakpoint = window.matchMedia(breakpoint);
                const enableSwiper = function(className, settings) {
            ...
            resizableSwiper("(max-width: 479.98px)", ".page_price .tariffs__body", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".blog-wrapper__body")) {
            const resizableSwiper = (breakpoint, swiperClass, swiperSettings, callback) => {
                let swiper;
                breakpoint = window.matchMedia(breakpoint);
                const enableSwiper = function(className, settings) {
            ...
            const someFunc = instance => {};
            resizableSwiper("(max-width: 479.98px)", ".blog-wrapper__body", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".template__body")) new swiper_core_Swiper(".template__body", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    function headerScroll() {
        ...
        document.addEventListener("windowScroll", (function(e) {
            ...
            if (scrollTop >= startPoint) {
                ...
                if (headerShow) {
                    if (scrollTop < scrollDirection) !header.classList.contains("_header-show") ? header.classList.add("_header-show") : null; else !header.classList.contains("_header-show") ? header.classList.add("_header-show") : null;
                    timer = setTimeout((() => {
    ...
    function elementScroll() {
        addWindowScrollEvent = true;
        const header = document.querySelector(".button-up");
        const startPoint = header.dataset.scroll ? header.dataset.scroll : 1;
        let scrollDirection = 0;
        let timer;
        document.addEventListener("windowScroll", (function(e) {
            const scrollTop = window.scrollY;
            clearTimeout(timer);
            if (scrollTop >= startPoint) !header.classList.contains("_element-scroll") ? header.classList.add("_element-scroll") : null; else header.classList.contains("_element-scroll") ? header.classList.remove("_element-scroll") : null;
            scrollDirection = scrollTop <= 0 ? 0 : scrollTop;
        }));
    }
    setTimeout((() => {
